...
public class ListadoProfesores extends javax.swing.JDialog {
    ...
    public ListadoProfesores(java.awt.Frame parent, boolean modal) {
        ...
        /*Cargamos la tabla con los datos de profesores*/
        cargarTabla();
    }
    ...
    private void initComponents() {
        ...
        TablaProfesores = new javax.swing.JScrollPane();
        ...
        jTableProfesores.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        TablaProfesores.setViewportView(jTableProfesores);

        getContentPane().add(TablaProfesores, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 120, 810, 240));
        ...
        BotonAnadirProfesor.setText("Añadir");
        BotonAnadirProfesor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotonAnadirProfesorActionPerformed(evt);
            }
        });
        ...
        BotoneraInferiorLayout.setHorizontalGroup(
            ...
            .addGroup(BotoneraInferiorLayout.createSequentialGroup()
                ...
                .addComponent(BotonAnadirProfesor)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(BotonEliminarProfesor, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        BotonDetalleProfesor.setText("Detalle");
        BotonDetalleProfesor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotonDetalleProfesorActionPerformed(evt);
            }
        });
        ...
        BuscadorLayout.setHorizontalGroup(
            ...
            .addGroup(BuscadorLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(BotonDetalleProfesor)
                .addGap(14, 14, 14))
        );
        ...
        jLabelProfesores.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabelProfesores.setText("LISTADO DE PROFESORES");
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabelProfesores, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
        );
    ...
    private void BotonEliminarProfesorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEliminarProfesorActionPerformed
        try 
        {
            ...
            int fila_seleccionada = (jTableProfesores.getSelectedRow());
    ...
    private void textoBusquedaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textoBusquedaKeyTyped
        ...
        trsFiltro = new TableRowSorter(jTableProfesores.getModel());
        jTableProfesores.setRowSorter(trsFiltro);
    }//GEN-LAST:event_textoBusquedaKeyTyped

    private void BotonAnadirProfesorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonAnadirProfesorActionPerformed
        try
        {
    ...
    }//GEN-LAST:event_BotonAnadirProfesorActionPerformed

    private void BotonDetalleProfesorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonDetalleProfesorActionPerformed
        try
        {
    ...
    }//GEN-LAST:event_BotonDetalleProfesorActionPerformed
    
    /*Método que permite ver que elemento del combo esta seleccionado*/
    public void filtro() 
    {
        int columnaABuscar = 0;
        if (comboBusqueda.getSelectedItem() == "Dni" || comboBusqueda.getSelectedItem() == "dni") 
        {
            columnaABuscar = 4;
        }
    ...
    public void cargarTabla()
    {
        try
        {
            ...
            this.jTableProfesores.setModel(modelo);
            /*Consulta a base de datos*/
            Statement sentencia = conexion.createStatement();
            ResultSet profesores = sentencia.executeQuery("select dni, nombre, apellido1, apellido2, sexo, fechaAlta,fechaBaja from Profesores");
            /*Cabeceras de la tabla*/
            configuraColumnasTabla(profesores, modelo);
            /*Datos de la tabla*/
            anadeDatosTabla(profesores, modelo);
            /*Cerramos la conexion*/
            sentencia.close();
            conexion.close();
        }
    ...
    public static void configuraColumnasTabla(ResultSet rs, DefaultTableModel model)
    {
        try
        {
            ...
            for (int i = 0; i < numero_columnas; i++)
            {
                ...
                if(cabeceras_bd.equals("apellido1"))
                {
                    cabeceras[i] = "1º APELLIDO";
                }
                if(cabeceras_bd.equals("apellido2"))
                {
                    cabeceras[i] = "2º APELLIDO";
                }
                if(cabeceras_bd.equals("sexo"))
                {
                    cabeceras[i] = "SEXO";
                }
    ...
    private javax.swing.JButton BotonAnadirProfesor;
    private javax.swing.JButton BotonDetalleProfesor;
